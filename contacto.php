...
<head>
  ...
  <title>Contacto - Arte &amp; Cultura em Movimento</title>
    ...
    <div class="container"><a class="navbar-brand" href="index.php"><img src="img/logo.png" alt="logo"></a><button
      ...
      <div class=" collapse navbar-collapse" id="navbarSupportedContent">
       <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a class="nav-link get_touch" href="contacto">contactos</a></li>
        </ul>
      </div>
    </div>
  </nav>
      ...
      <div class="row">
        <div class="col-12">
          <div class="hero-caption text-center">
           <h1 class="title">contactar ACM</h1>
