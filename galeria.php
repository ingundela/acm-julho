...
<head>
  ...
  <title>Galeria - Arte &amp; Cultura em Movimento</title>
...
<body id="home">
       ...
       <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown dropbtn"><a class="nav-link servi_icon" href="#">serviços</a>
            <div class="dropdown-content">
             ...
             <li class="nav-item active"><a class="nav-link get_touch" href="galeria">galéria</a></li>
  ...
  <section id="hero_other_pages">
   ...
   <section class="gallery_of_photos mt-4 mb-4"> <!-box 1->
        <div class="container">
           <div class="gallery_content">
               <div class="row">
                   <div class="col-md-4 col-sm-12">
                       <div class="gallery_box">
                            <a href="img/gallery/p1.jpg" data-lightbox="gallery" class="mybox mx-auto"> <img
                                    src="img/gallery/p1.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p2.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p2.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p3.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p3.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
               </div>
     ...
     <section class="gallery_of_photos mt-4 mb-4"> <!-box 2->
        <div class="container">
           <div class="gallery_content">
               <div class="row">
                   <div class="col-md-4 col-sm-12">
                       <div class="gallery_box">
                            <a href="img/gallery/p4.jpg" data-lightbox="gallery" class="mybox mx-auto"> <img
                                    src="img/gallery/p4.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p5.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p5.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p6.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p6.jpg"alt="deep cleaning">
                            </a>
                       </div>
                   </div>
               </div>
     ...
     <section class="gallery_of_photos mt-4 mb-4"> <!-box 3->
        <div class="container">
           <div class="gallery_content">
               <div class="row">
                   <div class="col-md-4 col-sm-12">
                       <div class="gallery_box">
                            <a href="img/gallery/p7.jpg" data-lightbox="gallery" class="mybox mx-auto"> <img
                                    src="img/gallery/p7.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p8.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p8.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p9.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p9.jpg"alt="deep cleaning">
                            </a>
                       </div>
                   </div>
               </div>
     ...
     <section class="gallery_of_photos mt-4 mb-4"> <!-box 4->
        <div class="container">
           <div class="gallery_content">
               <div class="row">
                   <div class="col-md-4 col-sm-12">
                       <div class="gallery_box">
                            <a href="img/gallery/p10.jpg" data-lightbox="gallery" class="mybox mx-auto"> <img
                                    src="img/gallery/p10.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p11.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p11.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p12.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p12.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
               </div>
     ...
     <section class="gallery_of_photos mt-4 mb-4"> <!-box 5->
        <div class="container">
           <div class="gallery_content">
               <div class="row">
                   <div class="col-md-4 col-sm-12">
                       <div class="gallery_box">
                            <a href="img/gallery/p13.jpg" data-lightbox="gallery" class="mybox mx-auto"> <img
                                    src="img/gallery/p13.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p14.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p14.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="gallery_box">
                            <a href="img/gallery/p15.jpg" data-lightbox="gallery" class="mybox"> <img
                                    src="img/gallery/p15.jpg" alt="deep cleaning">
                            </a>
                       </div>
                   </div>
               </div>
