...
<head>
  ...
  <title>Sobre - Arte &amp; Cultura em Movimento</title>
      ...
      <div class="row align-items-center">
        <div class="col-md-7">
          <div class="sobre_nos_content">
            ...
            <p>Somos reconhecidos pela qualidade do atendimento que prestamos aos nossos clientes durante e após o processo de exrcuҫão dos projectos. Transparência e responsabilidade com os recursos investidos sao marcas fortes de nosso trabalho.</p>
          </div>
        </div>
        <div class="col-md-5">
          <div class="sobre_img">
          ...
          <div class="values_mission_box">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p>Promover o desenvolvimento sustentável do Turismo, da Cultura e da Economia Criativa.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="values_mission_box">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p>Uma administraҫão humanizada e digna de admiraҫão.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="values_mission_box">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p>Transparência, ética, compromisso com o cidadão e com os agentes da cadeia produtiva da Economia Criativa e Cultural.</p>
              </div>
            </div>
          </div>
        </div>
